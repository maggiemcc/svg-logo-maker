...
describe('Square Test', () => {
    test('Render a red square', () => {
        const square = new Square('REC', 'black', "Arial, 'sans-serif'", 'red', 'black');
        ...
        <text x="125" y="120" font-size="50" text-anchor="middle" font-family="Arial, 'sans-serif'" fill="black">REC</text>
        </svg>`)
    });
});
