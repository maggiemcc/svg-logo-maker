function shapes(data) {
    ...
    <text x="150" y="125" font-size="50" text-anchor="middle" font-family="${fontFamily}" fill="${data.tColor}">${data.text}</text>
    </svg>
    `
        ...
        <text x="125" y="120" font-size="50" text-anchor="middle" font-family="${fontFamily}" fill="${data.tColor}">${data.text}</text>
        </svg>
        `
        ...
        <text x="150" y="150" font-size="50" text-anchor="middle" font-family="${fontFamily}" fill="${data.tColor}">${data.text}</text>
        </svg>
        `
    }
};
